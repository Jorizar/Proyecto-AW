...
if (! INSTALADA) {
	$app->paginaError(502, 'AAAAa', 'Oops', 'La aplicación no está asdfdfsafdsadfsdfsfdsdfssfdafdsafds. Tienes que modificar el fichero config.php');
}
